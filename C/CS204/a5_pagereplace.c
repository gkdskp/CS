...
(a) FIFO (b) LRU
{ You can assume the number of frames.
(for example 3 frames (3 pages can be in memory at a time )
Input a page reference string for process with 8 pages (0 to 7)
Reference string: 7,0,1,2,0,3,0,4,2,3,0,3,0,3,2,1,2,0,1,7,0,1

Display the memory status after each page fault. (Assume the process
starts with no page in memory)

Memory status : 7FF 70F 701 201 ..........

Compute the total number of page faults in each case.} */
