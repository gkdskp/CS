...
\lstinputlisting[language=C]{Source/p1merge.c}
\newpage
...
\lstinputlisting[language=C]{Source/p2palindrome.c}
\newpage
...
\lstinputlisting[language=C]{Source/p3circle.c}
\newpage
...
\lstinputlisting[language=C]{Source/p4queue.c}
\newpage
...
\subsection{Description}
 ...
 \lstinputlisting[language=C]{Source/p5dnf.c}
\end{document}