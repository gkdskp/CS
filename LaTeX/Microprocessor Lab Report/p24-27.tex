...
\input{experiments/p24_positivenegative.tex}

\newpage
\input{experiments/p25_countonesandzeros.tex}

\newpage
\input{experiments/p26_linearsearch.tex}

\newpage
\input{experiments/p27_factorial.tex}
\end{document}